...
import (
	...
	"github.com/joelpm/kubegateway/Godeps/_workspace/src/github.com/GoogleCloudPlatform/kubernetes/pkg/auth/user"
	"github.com/joelpm/kubegateway/Godeps/_workspace/src/golang.org/x/net/context"
)
